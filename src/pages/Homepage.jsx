    ...
    <Layout aditionalStyles="min-h-screen min-w-screen">
      <form className="flex py-2 px-5 w-400">
        <input
          ...
          type="text"
          id="simple-search"
          className="md:w-1/3 sm:w-full sticky  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-800 pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          placeholder="Search"
          required
        />
